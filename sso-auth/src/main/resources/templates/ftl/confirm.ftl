...
<nav class="navbar navbar-default container-fluid">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">点米开放平台</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://dianmi365.com">技术支持</a>
            </p>
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://dianmi365.com">${user.username}</a>
            </p>
        </div>
    </div>
</nav>
...
<footer>
    <p>support by: dianmi365.com</p>
    <p>email: <a href="mailto:dianmi365@gmail.com">yangbin@dianmi355.com</a>.</p>
</footer>
</body>
</html>
